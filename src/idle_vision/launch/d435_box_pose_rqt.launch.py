"""Launch D435 box pose pipeline with rqt_image_view windows."""
...
def generate_launch_description() -> LaunchDescription:
    start_rqt_arg = DeclareLaunchArgument(
        "start_rqt",
        default_value="true",
        description="Start rqt_image_view windows.",
    )
    ...
    depth_view = Node(
        ...
        output="screen",
        condition=IfCondition(LaunchConfiguration("start_rqt")),
        arguments=["/camera/camera/aligned_depth_to_color/image_raw"],
    )
