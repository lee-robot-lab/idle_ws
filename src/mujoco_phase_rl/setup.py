...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name, ['FINAL_CLI_README.ko.md']),
        ('share/' + package_name, ['VISION_ESTIMATOR_ARCHITECTURE.ko.md']),
        ('share/' + package_name, ['information_read.md']),
        ('share/' + package_name, ['TASK_ROUTING.ko.md']),
        ('share/' + package_name + '/config', ['config/policy_routes.json']),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'train_multicolor_pipeline = mujoco_phase_rl.policies.train_multicolor_pipeline:main',
            ...
            'stage1_camera_smoke = mujoco_phase_rl.perception.stage1_camera_smoke:main',
            ...
            'route_task_intent = mujoco_phase_rl.intent.route_task_intent:main',
            'vision_intent_handoff = mujoco_phase_rl.intent.vision_intent_handoff:main',
            'sim_intent_runner = mujoco_phase_rl.intent.sim_intent_runner:main',
            'real_intent_action_bridge = mujoco_phase_rl.bridges.real_intent_action_bridge:main',
        ],
    },
)
