...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('settle_kp_scale_by_motor_json',   default_value='{1: 1, 2: 1.4, 4: 1}'),
        ...
        DeclareLaunchArgument('settle_friction_scale',           default_value='1.0'),
        ...
        DeclareLaunchArgument('hold_kp_scale_by_motor_json',     default_value='{ 1: 1, 2: 1.8, 4: 1 }'),
        ...
        DeclareLaunchArgument('settle_qd_lpf_alpha',             default_value='0.9'),
        ...
        Node(
            ...
            parameters=[{
                ...
                'settle_kp_scale_by_motor_json':          LaunchConfiguration('settle_kp_scale_by_motor_json'),
                'settle_kd_scale_by_motor_json':          LaunchConfiguration('settle_kd_scale_by_motor_json'),
                ...
                'hold_friction_scale_by_motor_json':      LaunchConfiguration('hold_friction_scale_by_motor_json'),
                'hold_friction_deadband_rad':             ParameterValue(LaunchConfiguration('hold_friction_deadband_rad'), value_type=float),
                'hold_kp_scale_by_motor_json':            LaunchConfiguration('hold_kp_scale_by_motor_json'),
                'hold_kd_scale_by_motor_json':            LaunchConfiguration('hold_kd_scale_by_motor_json'),
