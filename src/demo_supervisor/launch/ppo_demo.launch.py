...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('hold_kp_scale_by_motor_json', default_value='{"1":0.4,"2":0.5,"3":0.8,"4":0.4,"5":0.3,"6":0.3}'),
        DeclareLaunchArgument('hold_kd_scale_by_motor_json', default_value='{"1":0.2,"2":0.3,"3":0.5,"4":0.2,"5":0.2,"6":0.2}'),
